module.exports = {
"Search for word that contains a number": function(browser) {
  browser
  // Navigate to duckduckgo
    ...
    browser.elements("css selector", '#links > div.results_links_deep', function(text){
      ...
      array.forEach(function(currentValue,index){
        ...
        browser.expect.element(browser.page.searchResults().getLinksByIndex(index + 1)).text.to.contain('1996'); //assert each result contains the search word
      });
